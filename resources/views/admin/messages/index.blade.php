        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr class='text-center'>
                    ...
                    <td><span class='d-inline-block text-truncate' style='max-width: 150px'>{{substr($message->content, 0, 30)}}</span></th>
                    <td>{{$message->created_at}}</th>
                    <td>{{$message->updated_at}}</th>
                    <td>
                        {{-- <a href="{{ route("admin.messages.create", $message->id)}}">  <!-- admin.messages.answer -->
                            Rispondi
                        </a> --}}
                        ...
                        <a href="{{route("admin.messages.edit", [Auth::user()->id, $message->id])}}">
